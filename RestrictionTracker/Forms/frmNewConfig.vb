...
#Region "Form Events"
  Private Sub frmNewConfig_Shown(sender As Object, e As System.EventArgs) Handles Me.Shown
    bLoaded = False
  ...
  Private Sub RunAccountTest(sKey As String)
    ...
    End If
  End Sub
  Private Sub frmNewConfig_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    If pChecker IsNot Nothing Then
      pChecker.Dispose()
      pChecker = Nothing
    End If
