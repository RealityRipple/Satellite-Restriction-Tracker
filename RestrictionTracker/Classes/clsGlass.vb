...
Friend Class clsGlass
  ...
  End Structure
  <DllImport("dwmapi.dll")> Private Shared Sub DwmIsCompositionEnabled(ByRef enabledptr As Integer)
  End Sub
  <DllImport("dwmapi.dll")> Private Shared Sub DwmExtendFrameIntoClientArea(ByVal hWnd As IntPtr, ByRef margin As MARGINS)
  End Sub
  ...
  <DllImport("gdi32.dll", ExactSpelling:=True)> Private Shared Function SelectObject(ByVal hDC As IntPtr, ByVal hObject As IntPtr) As IntPtr
  End Function
  ...
  <DllImport("gdi32.dll")> Private Shared Function BitBlt(ByVal hdc As IntPtr, ByVal nXDest As Integer, ByVal nYDest As Integer, ByVal nWidth As Integer, ByVal nHeight As Integer, ByVal hdcSrc As IntPtr, ByVal nXSrc As Integer, ByVal nYSrc As Integer, ByVal dwRop As UInteger) As Boolean
  End Function
  ...
  Public Shared Sub DrawTextOnGlass(ByVal hwnd As IntPtr, ByVal text As String, ByVal Font As Font, ByVal ctlRct As Rectangle, ByVal Margin As Integer, ByVal iGlowSize As Integer)
    If IsCompositionEnabled() Then
      ...
      Dim uFormat As Integer = DT_SINGLELINE Or DT_NOPREFIX Or DT_VCENTER
